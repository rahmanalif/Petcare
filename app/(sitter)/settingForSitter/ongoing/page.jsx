...
export default function OngoingDetails() {
    ...
    const handleRescheduleSubmit = async () => {
        ...
        const startDate = new Date(rescheduleForm.startDate).toISOString();
        const endDate = new Date(rescheduleForm.endDate).toISOString();
        dispatch(requestReschedule({ id: booking._id, reason: rescheduleForm.reason, startDate, endDate }));
    };
                                ...
                                <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                                    ...
                                    {showPetDetails && (
                                        <div className="p-6 pt-0 space-y-6">
                                            ...
                                            <div className="p-4 border border-gray-100 rounded-lg">
                                                <SectionHeading title="Veterinary info" icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="6" width="20" height="12" rx="2" /><circle cx="12" cy="12" r="2" /><path d="M6 12h.01M18 12h.01" /></svg>} />
