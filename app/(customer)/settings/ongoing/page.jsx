  ...
  return (
    <div className="bg-gray-50 min-h-screen p-6">
      <div className="max-w-6xl border-2 border-gray-200 rounded-lg bg-white m-2 p-2 mx-auto">
        ...
        <h1 className="text-2xl font-semibold text-[#024B5E] px-6 pb-6 pt-2 mb-2">
          On going details
        </h1>
        ...
        {activeView === "reschedule" ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h2 className="text-lg font-semibold text-[#024B5E] mb-4">Note</h2>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#035F75] text-[#024B5E]"
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  <label className="block text-sm font-medium text-[#024B5E] mb-2">Start time</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#024B5E] mb-2">End time</label>
                  <input
                    type="text"
                    defaultValue="11:00pm"
                    className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#035F75] text-[#024B5E]"
