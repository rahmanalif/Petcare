      ...
      <nav className="flex items-center justify-between px-4 md:px-8 py-4 max-w-7xl mx-auto">
        <Link href="/" className="relative w-24 h-10 md:w-32 md:h-12 cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" width="61" height="50" viewBox="0 0 61 50" fill="none">
            ...
            <path d="M46.1879 13.5692C45.954 14.553 45.3192 15.2287 44.5285 15.7819C43.207 16.7026 41.7592 17.3263 40.1258 17.3448C39.6099 17.3523 39.053 17.2557 38.5816 17.0553C37.6721 16.6692 37.2823 15.8821 37.3491 14.9169C37.5644 11.6721 38.1064 8.4868 39.2758 5.43512C39.6395 4.48472 40.0702 3.56402 40.7681 2.80295C40.8386 2.72499 40.9128 2.65074 41.0391 2.51709C40.7903 2.9663 40.5565 3.33384 40.3709 3.72737C39.8066 4.91165 39.517 6.18504 39.2349 7.45843C38.7894 9.49288 38.563 11.557 38.3922 13.6323C38.3588 14.0407 38.3366 14.4491 38.3254 14.8575C38.3031 15.5703 38.8043 16.2162 39.5133 16.309C40.3152 16.413 41.091 16.2682 41.852 16.0417C42.8209 15.7522 43.6859 15.2695 44.4729 14.6347C45.271 13.9924 45.5049 13.1014 45.5531 12.1436C45.6385 10.5175 45.4269 8.91373 45.0817 7.3285C44.8812 6.40037 44.6548 5.47224 44.4395 4.54783C44.4209 4.46244 44.4023 4.38077 44.3838 4.29538C44.4023 4.29167 44.4172 4.28424 44.4357 4.28053C44.6288 4.77429 44.8292 5.26063 45.0111 5.75811C45.6979 7.62921 46.2362 9.53372 46.3364 11.5385C46.3698 12.2253 46.3512 12.901 46.1916 13.5729L46.1879 13.5692Z" fill="white" />
            <path d="M7.28042 45.9942C5.24241 40.7039 3.34547 35.0534 3.02251 29.3919C2.98167 28.6939 2.58446 28.8313 2.62159 29.5329C2.95197 35.2836 4.16958 40.9563 6.241 46.332C6.49343 46.9817 7.52914 46.6513 7.27671 45.9942H7.28042Z" fill="#F2F2F2" />
            <path d="M2.6981 24.1759C2.40483 24.2019 2.16354 24.4395 2.17839 24.7439L2.27862 26.9008C2.29346 27.1867 2.21922 27.4503 2.51248 27.4206C2.80575 27.3946 3.04704 27.157 3.0322 26.8526L3.26607 24.6956C3.25122 24.4098 2.99136 24.1499 2.6981 24.1759Z" fill="#F2F2F2" />
          </svg>
        </Link>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white/95 backdrop-blur-md border-t border-gray-200">
          <div className="flex flex-col px-4 py-4 space-y-4">
            <Link href="/" className="text-gray-700 hover:text-teal-600 transition py-2" onClick={() => setIsMobileMenuOpen(false)}>
              {t("navbar.home")}
            </Link>
            <a href="#services" className="text-gray-700 hover:text-teal-600 transition py-2" onClick={() => setIsMobileMenuOpen(false)}>
              {t("navbar.services")}
            </a>
            <a href="/sitterhome" className="text-gray-700 hover:text-teal-600 transition py-2" onClick={() => setIsMobileMenuOpen(false)}>
              {t("navbar.become_sitter")}
            </a>
            <a href="#faqs" className="text-gray-700 hover:text-teal-600 transition py-2" onClick={() => setIsMobileMenuOpen(false)}>
              {t("navbar.faqs")}
            </a>
