            ...
            <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="space-y-8">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="text-white">
                            <h3 className="text-2xl font-bold mb-2 font-bakso" >
                                {t("home_services.boarding_title")}
                            </h3>
                            <p className="text-sm md:text-base leading-relaxed">
                                {t("home_services.boarding_desc")}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="text-white">
                            <h3 className="text-2xl font-bold mb-2 font-bakso">
                                {t("home_services.daycare_title")}
                            </h3>
                            <p className="text-sm md:text-base leading-relaxed">
                                {t("home_services.daycare_desc")}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="text-white">
                            <h3 className="text-2xl font-bold mb-2 font-bakso">
                                {t("home_services.walking_title")}
                            </h3>
                            <p className="text-sm md:text-base leading-relaxed">
                                {t("home_services.walking_desc")}
                            </p>
                        </div>
                    </div>
                </div>
