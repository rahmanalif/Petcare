...
const pawImage = ({ className }) => (
  ...
  >
    <path
      d="M31.5345 29.6491C25.0757 31.0418 24.5621 37.2951 19.524 43.9207C12.2953 53.6146 14.9923 60.4736 20.5016 60.9858C26.011 61.4981 29.4802 54.6623 35.3549 53.944C41.0839 52.8549 46.5547 58.1286 51.518 55.6324C56.5542 53.3216 56.9954 45.8042 47.1468 39.1162C40.5446 34.7446 38.0295 28.8884 31.5345 29.6491Z"
      fill="#FE6C5D"
    />
    <path
      d="M13.8998 26.9416C18.2312 31.7878 19.6867 38.0597 17.1792 40.9368C14.498 43.8861 8.83762 42.3437 4.50618 37.4975C0.174735 32.6513 -1.28067 26.3794 1.22681 23.5023C3.90802 20.5529 9.56837 22.0954 13.8998 26.9416Z"
      fill="#FE6C5D"
    />
    <path
      d="M46.187 21.5602C43.366 27.2986 44.0418 33.3213 47.5073 35.1403C50.9728 36.9593 56.1334 33.9429 58.9544 28.2045C61.7753 22.4661 61.0996 16.4433 57.6341 14.6244C53.9868 12.881 48.8261 15.8974 46.187 21.5602Z"
      fill="#FE6C5D"
    />
    <path
      d="M26.7903 12.2755C29.1509 18.8129 27.7238 25.3309 23.8568 26.7118C19.9897 28.0927 14.946 23.8108 12.5854 17.2734C10.2248 10.736 11.6519 4.218 15.519 2.83714C19.3861 1.45627 24.4298 5.73817 26.7903 12.2755Z"
      fill="#FE6C5D"
    />
    <path
      d="M30.2161 11.4775C30.1144 17.9759 33.3501 23.086 37.2505 23.1296C41.3265 23.1 44.6265 17.9784 44.7986 11.659C44.9003 5.16051 41.6647 0.0504128 37.7643 0.00689055C33.7936 -0.215616 30.3178 4.97903 30.2161 11.4775Z"
      fill="#FE6C5D"
    />
  </svg>
);
...
export default function WhatUserSay() {
  ...
  return (
    <div className="bg-[#F8F4EF] py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-start mb-8">
          ...
          <div className="flex-1 text-center px-8">
            <h1 className="font-bakso text-[48px] text-[#024B5E] mb-4">
              WHAT OUR USERS SAY
            </h1>
            <p className="font-montserrat text-[18px] text-[#024B5E]">
        ...
        {/* Testimonial Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 bg-white overflow-hidden shadow-md hover:shadow-lg transition-shadow p-6 rounded-lg">
