  ...
  const services = [
    {
      ...
      price: 99,
      unit: "per night",
      note: "In the siter's home",
    },
    { name: "Holiday Rate", price: 30, unit: "per night" },
    { name: "Puppy Rate", price: 40, unit: "per night" },
    { name: "Cat Care", price: 46, unit: "per night" },
    { name: "Additional Cat", price: 46, unit: "per night" },
    { name: "Stays of 9 Nights or more", price: 45, unit: "per night" },
    { name: "Bathing/ Grooming", price: 41, unit: "each" },
    {
    ...
    },
    {
      ...
      price: 99,
      unit: "Per walk",
      note: "In your neighbourhood",
    },
    { name: "60 minute rate", price: 15, unit: "", note: "Per walk" },
    { name: "Holiday rate", price: 33, unit: "", note: "per dog per walk" },
    { name: "Puppy Rate", price: 48, unit: "", note: "Per walk" },
  ];
            ...
            {!showBooking ? (
              ...
              <CardContent className="p-6 m-2">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg">Seam Rahman</h3>
            ...
            <Card>
              <CardContent className="p-4">
                {services.map((service, index) => {
                  const getIcon = () => {
                    if (index === 0)
                      return <BoardingIcon className="w-5 h-5 shrink-0 it" />;
                    if (index === 9)
                      return <WalkingIcon className="w-5 h-5 shrink-0" />;
                    return null;
                  };
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <DetailItem
                          ...
                          text="Potty breaks every 2-4 hours"
                        />
                      </div>
                    </CardContent>
                  </Card>
